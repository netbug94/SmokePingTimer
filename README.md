## SmokePing App has been overloading and crashing in the latest versions of libreNMS integration, This code runs "systemctl Smokeping" every week to keep it from happening.
